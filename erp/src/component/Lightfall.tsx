...
const prepColors = (input?: string[]) => {
  ...
  const arr: RGB[] = [];
  // eslint-disable-next-line security/detect-object-injection -- reviewed, internal index only
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      const callIfFn = (obj: unknown, key: string) => {
        // eslint-disable-next-line security/detect-object-injection -- reviewed, internal cleanup key
